...
on(document, 'click', '#edit-user', e => {
    ...
    document.getElementById('email2').value = userInfo.children[2].innerHTML
...
on(document, 'click', '#delete-user', e => {
    const userTarget = e.target.parentNode.parentNode
    currentUserId = userTarget.children[0].innerHTML
console.log(userTarget.children[5].innerHTML)
    document.getElementById('id3').value = userTarget.children[0].innerHTML
    document.getElementById('age3').value = userTarget.children[3].innerHTML
    document.getElementById('email3').value = userTarget.children[2].innerHTML
    document.getElementById('username3').value = userTarget.children[1].innerHTML
    document.getElementById('roles3').value = userTarget.children[5].innerHTML
